...
Route::prefix('payment')->group(function () {
	Route::get('balance', 'CgratePaymentController@getAccountBalance');
	Route::post('/', 'CgratePaymentController@processPayment');
	Route::post('/cashout' , 'CgratePaymentController@processCashout');
});
